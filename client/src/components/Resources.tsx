// Restoration style: retain Racing-Control founder tooling with dark cockpit surfaces,
// colored resource hierarchy, high-density cards, and concise action-oriented copy.
...
const resources: Resource[] = [
  ...
  { name: "Y Combinator", url: "https://www.ycombinator.com", description: "$500K standard deal for early-stage startups across all industries", category: "yc", logo: "/manus-storage/yc-logo_37599741.png" },
  ...
  { name: "F6S Event Finder", url: "https://www.f6s.com/programs?type[]=short_event&sort=closest&sort_dir=desc", description: "Discover upcoming startup events, hackathons, pitch competitions, and networking opportunities sorted by proximity", category: "accelerator" },
  
  // Techstars
  { name: "Techstars", url: "https://www.techstars.com", description: "$220K investment with global mentorship network (6,300+ startups)", category: "techstars", logo: "/manus-storage/techstars-logo_670a0e22.webp" },
  
  // Top AI Accelerators & Incubators
  { name: "500 Global", url: "https://500.co", description: "$150K investment, 3,000+ portfolio companies including Canva", category: "accelerator", logo: "/manus-storage/500global-logo_9b4545d9.png" },
  ...
  { name: "GenAI Fund FastTrack", url: "https://genaifund.ai/fasttrack-ai-accelerator/", description: "World's first PoC-to-enterprise accelerator. $1M+ in cloud/compute grants, guaranteed enterprise PoC before joining, NVIDIA technical support, and fast-track to ASEAN expansion. 12-week hybrid program (Vietnam-based)", category: "accelerator" },
  ...
  { name: "Vercel AI Accelerator", url: "https://vercel.com/blog/the-vercel-ai-accelerator-is-back-with-6-million-in-credits", description: "$6M in credits for AI startups building with Vercel", category: "accelerator", logo: "/manus-storage/vercel-logo_6976c134.png" },
  { name: "Vercel AI SDK", url: "https://ai-sdk.dev/docs/introduction", description: "Open-source TypeScript toolkit for building AI apps with React, Next.js, Vue, and Svelte. Stream-first UI helpers, 20+ model providers, and edge-ready deployment", category: "accelerator", logo: "/manus-storage/vercel-logo_6976c134.png" },
  ...
  // Developer GTM Tools
  { name: "Reo.Dev", url: "https://reo.dev", description: "AI-native GTM platform for DevTool companies. De-anonymize GitHub traffic and convert intent signals into qualified leads", category: "accelerator", logo: "/manus-storage/reodev-logo_d7263c4a.jpg" },
    ...
    <div className="space-y-8">
      <div className="space-y-4">
        ...
        <div className="flex justify-center mb-6">
          <img 
            src="/manus-storage/15901_37777980.jpg" 
